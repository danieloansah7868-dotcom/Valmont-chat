...
function createStory(ownerId, { type, text, background, storageName, mime, size } = {}) {
...
module.exports = {
  ...
  STORY_TTL_MS, STORY_REACTIONS, STORY_BACKGROUNDS, CAMPAIGN_OBJECTIVES, CAMPAIGN_CTAS,
  // users and auth
