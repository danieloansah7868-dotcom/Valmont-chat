...
function makeUser({ phone = null, username, avatar = null, about = null, accountType = 'personal', businessProfile = null }) {
  const id = uuidv4();
...
function upsertUserByPhone(phone, { username, avatar, about, accountType, businessProfile } = {}) {
  let user = findUserByPhone(phone);
  if (!user) user = makeUser({ phone, username, avatar, about, accountType, businessProfile });
  else {
